    ...
    <div class="max-w-md mx-auto mt-16 mb-20 px-6">
        <div class="bg-white dark:bg-[#1c1c1e] rounded-xl shadow-md p-8 border border-slate-200 dark:border-[#141414]">
            <h2 class="text-3xl font-bold mb-6 text-slate-800 dark:text-white text-center">
                <i class="fas fa-user-plus text-[#54b5ff] mr-2"></i> {{ __('Register') }}
            </h2>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <!-- Name -->
                <div class="mb-4">
                    <label for="name" class="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1">{{ __('Name') }}</label>
                ...
                <!-- Password -->
                <div class="mb-4">
                    <label for="password" class="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1">{{ __('Password') }}</label>
                ...
                <!-- Confirm Password -->
                <div class="mb-4">
                    <label for="password_confirmation" class="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1">{{ __('Confirm Password') }}</label>
