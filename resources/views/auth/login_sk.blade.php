    ...
    <div class="max-w-md mx-auto mt-16 mb-20 px-6">
        <div class="bg-white dark:bg-[#1c1c1e] rounded-xl shadow-md p-8 border border-slate-200 dark:border-[#141414]">
            <h2 class="text-3xl font-bold mb-6 text-slate-800 dark:text-white text-center">
                <i class="fas fa-sign-in-alt text-[#54b5ff] mr-2"></i> Prihlásenie
            </h2>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <!-- Password -->
                <div class="mb-4">
                    <label for="password" class="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1">Heslo</label>
                ...
                <div class="flex items-center mb-4">
                    ...
                    <label for="remember_me" class="ml-2 text-sm text-gray-700 dark:text-gray-300">Zapamätať si ma</label>
                </div>
                ...
                <div class="flex justify-between items-center mb-6 text-sm">
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}"
                           class="text-[#54b5ff] hover:underline">Zabudli ste heslo?</a>
                    @endif
